...
# Are they all TRUE?
all( Ainv==A )
# Alternatively, are any not TRUE?
any( Ainv!=A )
...
# Hint: you may want to search for a function that will help you do this.

A = diag(15)
help.search("Upper triangular")

#Option 1: Start with a diagonal and fill in the upper triangle
index = upper.tri(A)
is(index)
A[index]
...
#Option 2: Start with a matrix of ones and remove the lower triangle
...
# Here's another example of using a logical matrix to index a matrix
index = matrix(FALSE, nrow=15, ncol=15)
index[1,3] = TRUE
index[2,5] = TRUE
index
A[index]