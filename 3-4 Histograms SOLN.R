...
x = seq(-5,5,by=.1)
?rnorm
dnorm(x) #This gives us the density function for a normal
lines(x, 1000*dnorm(x), col=4) #Forgot to account for binwidth...

hist(rand, breaks=seq(-5,5,.5), ylim=c(0,200))
lines(x, 1000/2*dnorm(x), col=4) #Divide by 2 because binwidth is 0.5

# Or, just plot the densities
