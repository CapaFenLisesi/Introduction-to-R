...
exFrame = data.frame( evens=seq(2,200,2) )
exFrame$trial = factor( rep( c("A","B","C","D","E"), each=20 ) )
exFrame$norm1 = rnorm(100)
exFrame$norm2 = rnorm(100)
lambda = rep( seq(5,25,by=5), each=20 )
lambda
exFrame$pois = rpois(100, lambda=lambda )
exFrame$precip = sample(BoulderDaily$precip, size=100)
